...
#. Open Chrome and enter **about:addons** to see that the F5 Access Guard add-on is installed.  The extension is download and installed via a browsers addon store.
